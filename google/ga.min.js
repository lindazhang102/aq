(function () {
    ...
    $c.prototype.encode = function () {
        for (var a = [], b = 0; b < this.uri.length; b++)this.uri[b] && (a[Math.floor(b / 6)] ^= 1 << b % 6);
    ...
    var Nd = function (a, b) {
        ...
        a = Dd(a);
        a = new $c(a);
        for (var b = vd.uri.slice(), c = 0; c < a.uri.length; c++)b[c] = b[c] || a.uri[c];
    ...
    function Ja(a) {
        if (100 != a.get(Ka) && La(arr(a, Q)) % 1E4 >= 100 * R(a, Ka))throw"abort";
    }

    function Ma(a) {
        if (Aa(arr(a, Na)))throw"abort";
    }
    ...
    function Sa(a) {
        var b = arr(a, gd) || oc() + "/collect", c = arr(a, fa);
        !c && a.get(Vd) && (c = "beacon");
        if (c) {
            var d = arr(a, Ra), e = a.get(Ia), e = e || ua;
            "image" == c ? wc(b, d, e) : "xhr" == c && wd(b, d, e) || "beacon" == c && x(b, d, e) || ba(b, d, e)
        } else ba(b, arr(a, Ra), a.get(Ia));
        a.set(Ia, ua, !0)
    }
    ...
    var gc = function (a, b) {
        ...
        if (!(La(arr(a, Q)) % 100 >= c) && (c = {}, Ec(c) || Fc(c))) {
            var d = c[Eb];
    ...
    var hc = !1, mc = function (a) {
            if ("cookie" == arr(a, ac)) {
                var b = arr(a, U), c = nd(a), d = kc(arr(a, Yb)), e = lc(arr(a, W)), g = 1E3 * R(a, Zb), ca = arr(a, Na);
            ...
            if ("cookie" == arr(a, ac) && !hc && (mc(a), !hc))throw"abort";
        }, Yc = function (a) {
            if (a.get(Wc)) {
                var b = arr(a, W), c = arr(a, $b) || xa(), d = Xc("__utma", c, b);
                d && (J(19), a.set(Tc, (new Date).getTime(), !0), a.set(Rc, d.R), (b = Xc("__utmz", c, b)) && d.hash == b.hash && a.set(Sc, b.R))
            }
        }, nd = function (a) {
            var b = Cc(arr(a, Q)), c = ic(arr(a, W));
            a = jc(arr(a, Yb));
            1 < a && (c += "-" + a);
            return ["GA1", c, b].join(".")
        }, Gc = function (a, b, c) {
    ...
    var Jd = function (a, b, c) {
        this.U = ed;
        this.aa = b;
        (b = c) || (b = (b = arr(a, V)) && "t0" != b ? Wd.test(b) ? "_gat_" + Cc(arr(a, Na)) : "_gat_" + Cc(b) : "_gat");
        this.Y = b
    }, Rd = function (a, b) {
        var c = b.get(Wb);
        b.set(Wb, function (b) {
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/, pc = function (a) {
        ...
        if ("cookie" == arr(a, ac)) {
            ...
            c || (c = arr(a, W), d = arr(a, $b) || xa(), c = Xc("__utma", d, c), void 0 != c ? (J(10), c = c.O[1] + "." + c.O[2]) : c = void 0);
    ...
    N.create = function (a) {
        ...
        b[V] || (b[V] = "t0");
        var c = "" + b[V];
        if (N.dictionary[c])return N.dictionary[c];
        b = new pc(b);
        N.dictionary[c] = b;
        N.arr.push(b);
        return b
    ...
    N.remove = function (a) {
        for (var b = 0; b < N.arr.length; b++)if (N.arr[b].get(V) == a) {
            N.arr.splice(b, 1);
            N.dictionary[a] = null;
            break
        }
    ...
    N.j = function (a) {
        return N.dictionary[a]
    };
    N.getAll = function () {
        return N.arr.slice(0)
    };
    N.N = function () {
        "ga" != gb && J(49);
        var a = O[gb];
